...
function rc_mdm_register_widgets() {
	...
	wp_add_dashboard_widget('widget_wpexplorer_feed', __('10acre Blog', 'rc_mdm'), 'wpex_dashboard_rss_box');
...
function wpex_dashboard_rss_box() {
	...
	$my_feeds = array( 'http://www.10acre.com/feed/');
	...
	foreach ( $my_feeds as $feed) :
		...
		// End <ul> tag
		echo '</ul><div style="margin-top:20px;padding-top:10px;border-top:1px solid #eee;">Feed from <a href="http://www.10acre.com" target="_blank">10acre.com</a></div></div>';
