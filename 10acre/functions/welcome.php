 ...
 *
 * @package WordPress
 * @subpackage Elegant 10acre Theme
 * @since 10acre 1.0
 */
			...
			<div>
				<div class="feature-section">
					...
					<div>
						...
						<p>
						<?php _e( 'This theme was created by <a href="http://www.10acre.com" target="_blank">10acre.com</a>.', 'wpex' );?>
						<br />
					...
					<div>
						...
						<p>
						<?php _e( '10acre.com shall not be held liable for any damages, including, but not limited to, the loss of data or profit, arising from the use of, or inability to use, this theme.', 'wpex' );?>
						</p>
					</div>
					...
					<div>
						...
						<a href="http://www.10acre.com/" target="_blank" class="button button-primary"><?php _e('Theme Page','wpex'); ?></a>
						<a href="http://www.10acre.com/" target="_blank" class="button button-primary"><?php _e('Documentation','wpex'); ?></a>
					</div>
		...
		<div class="wrap about-wrap">
			...
			<div>
				<div class="feature-section">
					...
					<p><?php _e( 'Below you will find links to plugins we (10acre.com staff) personally like and recommend. None of these plugins are required for your theme to work, they simply add additional functionality.', 'wpex' ); ?></p>
						...
						<ul style="list-style: disc;margin: 20px 0 0 20px;">
							...
							<li><span style="font-weight:bold">Contact Forms:</span> <a href="http://wordpress.org/plugins/contact-form-7/" target="_blank">Contact Form 7</a> or <a href="http://www.10acre.com/gravity-forms-plugin/" target="_blank">Gravity Forms</a></li>
							<li><span style="font-weight:bold">Backups:</span> <a href="https://vaultpress.com/" target="_blank">VaultPress</a></li>
							<li><span style="font-weight:bold">Shortcodes:</span> <a href="http://www.10acre.com/symple-shortcodes/" target="_blank">Symple Shortcodes</a></li>
							<li><span style="font-weight:bold">Page Builder:</span> <a href="http://www.10acre.com/visual-composer-wordpress-plugin/" target="_blank">Visual Composer</a></li>
							<li><span style="font-weight:bold">Image Sliders:</span class> <a href="http://www.10acre.com/layer-slider-plugin/" target="_blank">LayerSlider</a></li>
					...
					<div>
						...
						<a href="http://www.10acre.com/total-wordpress-theme/" class="button button-primary" target="_blank">Total WordPress Theme</a>
					</div>

					<div>
						<h4><?php _e( 'WordPress Hosting', 'wpex' ); ?></h4>
						<p><?php _e( 'If you need fast and <a href="http://www.10acre.com/wordpress-hosting/" target="_blank">reliable hosting</a> we recommend the same host we use and love WPEngine.', 'wpex' ); ?></p>
						<a href="http://www.10acre.com/hosting/wpengine/" class="button button-primary" target="_blank">Learn About WPEngine</a>
					</div>

					<div>
						<h4><?php _e( 'Deals & Coupons', 'wpex' ); ?></h4>
						<p><?php _e( 'Check out our coupons page for great deals on WordPress resources.', 'wpex' ); ?></p>
						<a href="http://www.10acre.com/coupons/" class="button button-primary" target="_blank">View Deals/Coupons</a>
					</div>
